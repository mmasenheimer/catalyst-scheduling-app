...
const emptyForm = { name: '', maxHoursPerWeek: '' };
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="px-3 py-1.5 rounded-md text-xs font-semibold cursor-pointer hover:opacity-80 transition-opacity shrink-0"
